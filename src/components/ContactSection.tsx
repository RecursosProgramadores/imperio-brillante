...
const WHATSAPP_LINK = "https://wa.me/51933897123?text=Hola,%20quiero%20información%20sobre%20Molino%20Imperio";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start">
          ...
          <div className="order-2 lg:order-1">
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl h-48 md:h-80 border border-border/50">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3947.134876885779!2d-74.5812646!3d-8.388392299999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91a3bd5e1e53ebd3%3A0x4d1ccade129d3f13!2sMolino%20Imperio!5e0!3m2!1ses-419!2spe!4v1768512404888!5m2!1ses-419!2spe"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
